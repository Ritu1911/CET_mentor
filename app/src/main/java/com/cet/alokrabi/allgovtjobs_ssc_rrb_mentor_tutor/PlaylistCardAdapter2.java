 ...
 */
public class PlaylistCardAdapter2 extends RecyclerView.Adapter<PlaylistCardAdapter2.ViewHolder> {

    private static final DecimalFormat sFormatter = new DecimalFormat("#,###,###");
    private final PlaylistVideos2 mPlaylistVideos2;
    private final YouTubeRecyclerViewFragment2.LastItemReachedListener mListener;
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View v) {
            ...
            mTitleText = (TextView) v.findViewById(R.id.video_title2);
            //mDescriptionText = (TextView) v.findViewById(R.id.video_description);
            mThumbnailImage = (ImageView) v.findViewById(R.id.video_thumbnail2);
            mShareIcon = (ImageView) v.findViewById(R.id.video_share);
            mShareText = (TextView) v.findViewById(R.id.video_share_text);
            mDurationText = (TextView) v.findViewById(R.id.video_dutation_text2);
    ...
    public PlaylistCardAdapter2(PlaylistVideos2 playlistVideos2, YouTubeRecyclerViewFragment2.LastItemReachedListener lastItemReachedListener) {
        mPlaylistVideos2 = playlistVideos2;
        mListener = lastItemReachedListener;
    }

    // Create new views (invoked by the layout manager)
    @Override
    public PlaylistCardAdapter2.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // inflate a card layout
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.youtube_video_card2, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        if (mPlaylistVideos2.size() == 0) {
            return;
        }

        final Video video = mPlaylistVideos2.get(position);
        ...
        holder.mTitleText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Video pos =  mPlaylistVideos2.get(position);
       ...
       /* View.OnClickListener shareClickListener = new View.OnClickListener() {
        ...
        if (mListener != null) {
            ...
            final String nextPageToken = mPlaylistVideos2.getNextPageToken();
            if (!isEmpty(nextPageToken) && position == mPlaylistVideos2.size() - 1) {
