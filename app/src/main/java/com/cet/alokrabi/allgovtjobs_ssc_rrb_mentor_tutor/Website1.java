 ...
 */
public class Website1 extends Fragment {
    ...
    public static Website1 newInstance() {
        Website1 fragment = new Website1();
        return fragment;
    }
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        myFragment = inflater.inflate(R.layout.fragment_website1, container, false);

        mProgress = (ProgressBar)myFragment.findViewById(R.id.mProgress);
        String url = "http://www.qmaths.in/";
