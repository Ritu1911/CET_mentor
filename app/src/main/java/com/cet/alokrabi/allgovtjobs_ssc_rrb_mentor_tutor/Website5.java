 ...
 */
public class Website5 extends Fragment {
    ...
    public static Website5 newInstance() {
        Website5 fragment = new Website5();
        return fragment;
    }
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        myFragment = inflater.inflate(R.layout.fragment_website5, container, false);

        mProgress = (ProgressBar)myFragment.findViewById(R.id.mProgress);
        String url = "https://kvclasses.com";
