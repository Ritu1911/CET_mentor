 ...
 */
public class MehendiFragment extends Fragment {
    ...
    private static final String[] YOUTUBE_PLAYLISTS1 = {
            ...
            "PLOwEFL8-OcSc1QkzMdafIzU68j1iLCjEk",
            "PLOwEFL8-OcSdXyPa6BJGWQJn_gr1q9YkB",
            "PLOwEFL8-OcSdfitKvtS-yUQgp1uX5ribJ",
            "PLOwEFL8-OcSfX6DeqFgQSxPgNL8Zq7Rp7",
            "PLOwEFL8-OcSdt2-kMZ9g77kZ4BmA_p1jW",
            "PLOwEFL8-OcSfC_LC_CYvDU-SM_-FVviWc",
            "PLOwEFL8-OcScdA76Zh9tSv6ovQDji11bw",
            "PLOwEFL8-OcSeb3QYrP_bzPPSzmJEO_ylO",
            "PLOwEFL8-OcSeg6TvWPbRR1lfztNuq0-lj",
            "PLOwEFL8-OcSe3bsiy-6_d1xOQI3Enl3Xz",
            "PLOwEFL8-OcSczKq-wY7HEefUyvbrw7iHj",
            "PLOwEFL8-OcSd-FjaY87UZklBbohYm9odR",
            "PLOwEFL8-OcSeWU1FACtghTwL-F82UOvos",

            "PLxewAQmWoJEUhGIEmToDhnH-S0QFw2C_G"
    ...
    public MehendiFragment() {

        // Required empty public constructor
    }
    public static MehendiFragment newInstance() {
        MehendiFragment MehendiFragment = new MehendiFragment();
        return MehendiFragment;
    }
    @Override
    ...
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container3, Bundle savedInstanceState) {
        myFragment1 = inflater.inflate(R.layout.fragment_mehendi, container3, false);
...
// Create and start a new Thread
        ...
        if (ApiKey.YOUTUBE_API_KEY.startsWith("YOUR_API_KEY")) {
            ...
            getActivity().getSupportFragmentManager().beginTransaction()
                    .add(R.id.container3, YouTubeRecyclerViewFragment.newInstance(mYoutubeDataApi, YOUTUBE_PLAYLISTS1))
                    .commit();
        }
   ...
   /* @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_recyclerview) {
            getActivity().getSupportFragmentManager().beginTransaction()
                    .replace(R.id.container3, YouTubeRecyclerViewFragment.newInstance(mYoutubeDataApi, YOUTUBE_PLAYLISTS1))
                    .commit();
            return true;
        }
