 ...
 */
public class Website3 extends Fragment {
    ...
    public static Website3 newInstance() {
        Website3 fragment = new Website3();
        return fragment;
    }
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        myFragment = inflater.inflate(R.layout.fragment_website3, container, false);

        mProgress = (ProgressBar)myFragment.findViewById(R.id.mProgress);
        String url = "https://gradeup.co/";
