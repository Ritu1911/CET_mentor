 ...
 */
public class PlaylistCardAdapter4 extends RecyclerView.Adapter<PlaylistCardAdapter4.ViewHolder> {

    private static final DecimalFormat sFormatter = new DecimalFormat("#,###,###");
    private final PlaylistVideos4 mPlaylistVideos4;
    private final YouTubeRecyclerViewFragment4.LastItemReachedListener mListener;
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View v) {
            ...
            mTitleText = (TextView) v.findViewById(R.id.video_title4);
            //mDescriptionText = (TextView) v.findViewById(R.id.video_description);
            mThumbnailImage = (ImageView) v.findViewById(R.id.video_thumbnail4);
            mShareIcon = (ImageView) v.findViewById(R.id.video_share);
            mShareText = (TextView) v.findViewById(R.id.video_share_text);
            mDurationText = (TextView) v.findViewById(R.id.video_dutation_text4);
    ...
    public PlaylistCardAdapter4(PlaylistVideos4 playlistVideos4, YouTubeRecyclerViewFragment4.LastItemReachedListener lastItemReachedListener) {
        mPlaylistVideos4 = playlistVideos4;
        mListener = lastItemReachedListener;
    }

    // Create new views (invoked by the layout manager)
    @Override
    public PlaylistCardAdapter4.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // inflate a card layout
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.youtube_video_card4, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        if (mPlaylistVideos4.size() == 0) {
            return;
        }

        final Video video = mPlaylistVideos4.get(position);
        ...
        holder.mTitleText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Video pos =  mPlaylistVideos4.get(position);
       ...
       /* View.OnClickListener shareClickListener = new View.OnClickListener() {
        ...
        if (mListener != null) {
            ...
            final String nextPageToken = mPlaylistVideos4.getNextPageToken();
            if (!isEmpty(nextPageToken) && position == mPlaylistVideos4.size() - 1) {
