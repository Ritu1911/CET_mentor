...
public class Website2 extends Fragment {
    ...
    public static Website2 newInstance() {
        Website2 fragment = new Website2();
        return fragment;
    }
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        myFragment = inflater.inflate(R.layout.fragment_website2, container, false);

        mProgress = (ProgressBar)myFragment.findViewById(R.id.mProgress);
        String url = "https://www.knowledgephilic.com/";
