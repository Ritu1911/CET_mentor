...
public class VideoFragment extends Fragment {
    ...
    private static final String[] YOUTUBE_PLAYLISTS = {
            ...
            "PLOwEFL8-OcSfJvho94nAHRg08O4JOc22E",
            "PLOwEFL8-OcSfuads5PJazg9P6aweN65Vk",
            "PLOwEFL8-OcSezd2xG3e-zhvoHh6pehgZ6",
            "PLOwEFL8-OcScaJtgBhIy4gYY2HYr-YEVN",
            "PLOwEFL8-OcSfyZ7nDsCeHt9m-e9vLKWRg",
            "PLOwEFL8-OcSe4RwWM8pWGW5celofkjlJn",
            "PLOwEFL8-OcSc6ki_mHnmJJmB9x1fMtmNi",
            "PLOwEFL8-OcSeBhn_W2nUKmvcw-AX_VFrs",
            "PL4t_secZTPn4is-NJj9pHpQaGShQZiG_U",
            "PLOwEFL8-OcSfvQAhskHGVb9kOt2Z2stui",
            "PLT2PUxNJBoeOraTvKwYjs7QSSGSiDgTHx",
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        final ProgressBar pbar = (ProgressBar) myFragment2.findViewById(R.id.progressBar2); // Final so we can access it from the other thread
